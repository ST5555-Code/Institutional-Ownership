...
\f0\fs24 \cf0 # Shareholder Intelligence \'97 Style Guide\
\
...
\
### Accent \'97 Warm Gold (use sparingly)\
\
| Token | Value | Usage |\
|-------|-------|-------|\
...
| Section title | Display | 14px | 500 | \'97 | \'97 |\
| Kicker / label above data | Display | 9px | 700 | 0.16em | uppercase |\
| Body text | Sans | 13px | 400 | 0.02em | \'97 |\
| Secondary text | Sans | 11\'9612px | 400 | 0.04em | \'97 |\
| Button / control text | Sans | 10\'9611px | 500\'96700 | 0.06em | uppercase |\
| Large display number | Mono | 24px | 400 | -0.01em | \'97 |\
| Data / stat value | Mono | 11\'9613px | 500\'96600 | 0.06\'960.08em | \'97 |\
...
## Shadows\
\
Minimal \'97 only on floating elements:\
\
| Element | Shadow |\
|---------|--------|\
...
- Unselected: transparent background + `textDim` text, weight 400\'96500\
...
- Expandable rows: gold `\uc0\u9658 ` indicator that rotates 90\'b0 on expand\
...
- 9\'9610px, weight 600, uppercase, 0.06em spacing\
- Border-radius: 1px\
...
4. **Monospace for all numbers.** Prices, percentages, counts, stats \'97 always JetBrains Mono.\
