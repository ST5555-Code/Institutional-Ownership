...
| `entity_identifiers` | L3 | `build_entities.py` + `entity_sync.py` | staging→promote (SCD) | **33,392 active rows** (2026-04-17, net after INF23: closed 2 padded CRDs on fragmented Morningstar/DFA eids that merged into canonical + added 1 CIK backfill for Milliman eid=18304 from `adv_managers`); CIK/CRD/SERIES_ID bridge |
