...
| 008 | `008_rename_pct_of_float_to_pct_of_so.py` | renames `holdings_v2.pct_of_so` → `pct_of_so`; adds `pct_of_so_source` audit | **YES** | [scripts/migrations/008_rename_pct_of_float_to_pct_of_so.py:266-271](scripts/migrations/008_rename_pct_of_float_to_pct_of_so.py:266) | OK |
