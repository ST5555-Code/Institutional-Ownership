...
11b. **DM14 — intra-firm sub-adviser collapse** — now unblocked (DM13 done). Top candidates by AUM: Manulife/Manulife IM ($71B, 48 entities), FMR/FIAM ($43B, 3 entities), Principal/Principal Real Estate ($35B, 4 entities). ~300-500 series total. Extends DM8 collapse logic to walk `wholly_owned` / `parent_brand` chains.
