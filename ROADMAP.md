...
| DM12 | Umbrella fund trust routing cleanup | In progress | 2026-04-10: N-CEN "adviser" field lists ONE firm as primary adviser for entire umbrella fund trusts that host many unrelated managers. This routes 200+ series incorrectly to a single firm. AICF (Advisors' Inner Circle Fund) fixed: 24 series manually routed to actual managers (Acadian, Cambiar, LSV, Rice Hall James, Sands Capital, CIBC Private Wealth, Hamlin, Sarofim, Edgewood, Haverford). Remaining trusts with same issue: Glenmede, Manning & Napier, HC Capital Solutions, Innealta, Muzinich (APT Trust), Sterling Financial Group (Securian SFT), Heard Capital (SGI), AmFam, Quantum Advisors, Kennedy Capital (AXS/ACR), Bretton (Potomac/Cargile), Counterpoint (HCM/Swan), Tuttle, Vontobel, Polaris (DF Dent/AMPT), Christian Brothers (CRI), Inspire Investing. Each requires name-based routing similar to AICF fix. Estimated 150-200 additional series to re-route. Lower priority — affects mid-size advisers, not top-20 parents. |
