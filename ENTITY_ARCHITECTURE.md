...
- **DM14c (deferred)**: Voya IM Co 17915 ↔ Voya Investments 4071 — 49 funds / ~$21.81B AUM. Neither side has upward edges; no `Voya Financial Inc` holding entity in the MDM. Requires new seed entity before chain walk can close.
...
| DM14c Voya sibling collapse | ⏸ Deferred | 49 funds, needs new Voya Financial Inc seed | ~$21.81B |
| DM15 Layer 1 external sub-adviser | ✅ Done (`7bb68f5`) | 15 retargets, 4 sub-advisers | ~$10.3B |
| DM15b umbrella trusts | ⏸ Deferred | ~132 series, blocked on D13/DM6 | ~$105B |
| INF23 entity fragmentation cleanup | ✅ Done (`53d6e7b`) | 2 merges + Milliman CIK | — |
| **Cumulative DM corrections** | | **134 series** | **~$440B** |
