...
import { ExportBar, FreshnessBadge, PageHeader, getTypeStyle } from '../common'
import {
...
const TH: React.CSSProperties = {
  padding: '8px', fontSize: 9, fontWeight: 700,
  ...
  return (
    <div style={{ border: '1px solid var(--line)', borderRadius: 0, overflow: 'hidden' }}>
      <div style={{
        ...
        borderBottom: '1px solid var(--line)',
      }}>N-PORT Short Positions</div>
      <table style={{ width: '100%', borderCollapse: 'separate', borderSpacing: 0, tableLayout: 'fixed', fontSize: 12 }}>
        <colgroup>
          <col style={{ width: 28 }} /><col /><col style={{ width: 200 }} /><col style={{ width: 80 }} />
          <col style={{ width: 100 }} /><col style={{ width: 100 }} /><col style={{ width: 100 }} /><col style={{ width: 80 }} />
        </colgroup>
        <thead><tr>
